...
class DQN:
    ...
    def train(self):
        ...
        loss = F.mse_loss(target_q_values, q_values)  # Hint: try using q_values, target_q_values
        ### Your Code Ends >>>
...
class ActorCritic:
    ...
    def train(self):
        ...
        policy_loss = torch.mean(dist.logits[torch.arange(actions.shape[0]),actions]*advantage_detach)
